    ...
    <div className={css.main_container}>
      <div className={css.aside_menu}>
        <div className={css.menu_item}>
          ...
          <a href="#" className={css.item_link}>Маркетинговые возможности</a>
          <a href="#" className={css.item_link}>Календарь возможностей</a>
          <a href="#" className={css.item_link}>Заявки на размещение</a>
          <a href="#" className={css.item_link}>О курорте для брендов</a>
        </div>
        <div className={css.menu_item}>
          <div className={css.item_title}>Гостям курорта</div>
          <a href="#" className={css.item_link}>Основная информация</a>
          <a href="#" className={css.item_link}>Описание курорта</a>
          <a href="#" className={css.item_link}>Активности</a>
          <a href="#" className={css.item_link}>Отзывы</a>
          <a href="#" className={css.item_link}>Отели</a>
          <a href="#" className={css.item_link}>Блог</a>
          <a href="#" className={css.item_link}>События и мероприятия</a>
          <a href="#" className={css.item_link}>Фотографии</a>
        </div>
        <div className={css.menu_item}>
          <div className={css.item_title}>
            Настройки
      ...
      <div className={css.main_info}>
        ...
        <InputItem label={"Контактное лицо"} placeholder={"Константин Константинович Иванов"} name={"name"}/>
      ...
      <div className={css.logo_block}>
        ...
        <img className={css.logo_pic} src='images/icons/resort-logo.png' alt='logo' />
        <img className={css.mlogo_pic} src='images/icons/mresort-logo.png' alt='logo' />
